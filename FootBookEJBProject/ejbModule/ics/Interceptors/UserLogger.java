...
public class UserLogger {
    ...
    public Object logUserMethods(InvocationContext iCtx) throws Exception {
        System.out.println("*********************************");
        ...
        System.out.println("Exiting method: " + iCtx.getMethod().getName() + " in class " + iCtx.getTarget().getClass().getName() + " - Execution time: " + executionTime + " ms");
        System.out.println("*********************************");
